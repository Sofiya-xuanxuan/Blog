...
- **2.新引入了两个新的生命周期函数**
   ...
   - **getDerivedStateFromProps**
    ...
    ![react生命周期v16.3](https://i.loli.net/2019/12/30/BPUXIRqE2w8LmGg.png)
...
传统dom渲染过程：
![传统dom渲染](https://i.loli.net/2020/01/04/AwUX5LdVPjsrB9g.png)
...
```
![Hooks](https://i.loli.net/2020/01/04/E2edYPTniLA7IyN.png)
### 4.Fibter
...
![Fibter](https://i.loli.net/2020/01/04/jmvbgw9He3aML64.png)